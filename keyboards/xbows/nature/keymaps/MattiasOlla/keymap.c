...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
		...
		KC_LCTL,       MO(1),   LALT_T(KC_SPC),    KC_SPC,           KC_LCTL, KC_LSFT, KC_SPC,           RALT_T(KC_SPC),   KC_LGUI, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
  [1] = LAYOUT(
    ...
    RGB_TOG,       RGB_MOD, RGB_VAI, RGB_HUI,  KC_TRNS, KC_TRNS,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, SE_AA,   KC_TRNS, KC_TRNS, KC_MNXT,
    KC_TRNS,       RGB_SPD, RGB_VAD, RGB_SPI,  KC_TRNS, KC_TRNS,      KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, SE_OE,   SE_AE,   KC_TRNS,          KC_MPRV,
    LSFT(KC_LGUI), KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,      KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE,          KC_VOLU,
